  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative' >
      ...
      <div className='flex'>
          ...
          />
          <NavButton dotColor='#03C9D7' title="Chat" customFunc={()=>{}}
          color="blue" icon={<BsChatLeft/>}      
          />
          <NavButton dotColor='#03C9D7' title="Notifications" customFunc={()=>{}}
          ...
          >
            ...
            >
              ...
              <p> <span className='text-gray-400 text-14'>Hi,</span>{' '}<span className='font-bold text-gray-400 ml-1 text-14'>Yididiya</span></p>
